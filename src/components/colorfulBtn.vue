...
.colorful_btn_main {
  ...
  @apply flex-c w-112px h-34px relative overflow-hidden rounded-4px bg-#fff shadow-lg text-#333 hover:shadow-md active:shadow-sm dark:(bg-dark-400 text-shadow-xl shadow-dark-800 text-#d1d1d1);
}
