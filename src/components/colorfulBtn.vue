<template>
  <button
    ...
    ripple="ripple"
    border="~ #eee"
    shadow="lg hover:md active:sm dark:dark-800"
    text="#333 dark:#d1d1d1"
    bg="#fff dark:dark-400"
    class="colorful_btn_main flex-c transition-all w-112px h-34px relative overflow-hidden rounded-4px dark:(text-shadow-xl)"
